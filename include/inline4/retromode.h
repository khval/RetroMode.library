...
#define retroXorScreenBlit(SourceScreen, fromX, fromY, width, height, screen, toMode, toX, toY) IRetroMode->retroXorScreenBlit((SourceScreen), (fromX), (fromY), (width), (height), (screen), (toMode), (toX), (toY)) 
...
#define retroPasteSprite(screen, sprite, x, y, image, flags) IRetroMode->retroPasteSprite((screen), (sprite), (x), (y), (image), (flags)) 
