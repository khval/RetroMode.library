...
#define retroSetVideoColor(video, RGB, color, from, to) IRetroMode->retroSetVideoColor((video), (RGB), (color), (from), (to)) 
#define retroApplyCopper(video) IRetroMode->retroApplyCopper((video)) 
