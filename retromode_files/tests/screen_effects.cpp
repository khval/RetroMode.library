...
//			video -> rainbow[0].offset ++;
			...
			if (screen)	retroApplyScreen( screen, video, 0, y, 320, 100 );
			if (screen2)	retroApplyScreen( screen2, video, 0, 250-y, 640, 100  );
