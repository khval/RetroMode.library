...
extern void                 VARARGS68K _retromode_retroPolyLine(struct RetroModeIFace *, struct retroScreen * screen, int buffer, unsigned char color, ...);
extern void                 VARARGS68K _retromode_retroPolyGon(struct RetroModeIFace *, struct retroScreen * screen, int buffer, unsigned char color, ...);
...
extern void                 VARARGS68K _retromode_retroPasteSprite(struct RetroModeIFace *, struct retroScreen * screen, int buffer, struct retroSprite * sprite, int x, int y, int image, int flags, int srcMask, int destMask);
