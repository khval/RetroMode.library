...
/****** retromode/main/alloc_retoVideo ******************************************
*
*   NAME
*      alloc_retoVideo -- Description
*
*   SYNOPSIS
*      struct retroVideo * alloc_retoVideo(struct Window * window);
*
*   FUNCTION
*
*   INPUTS
       ...
       struct Window * window)
{
	...
	if (new_video)
	{
		...
		{
			 Self -> set_retroVideoColor( new_video, &RGB000,  color, 0 , new_video -> height );
		}
		...
		{
			Self -> free_retroVideo( new_video );
			return NULL;
		}
	}
