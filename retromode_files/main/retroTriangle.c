...
void draw_hline_fast(struct retroScreen *screen, int x,int y,int w, unsigned char c)
{
       ...
       unsigned char color)
{
	...
	for (y= my1 ; y<= my3;y++)
	{
		...
		draw_hline_fast(screen,xa,y,xb-xa,color);
		draw_hline_fast(screen,xb,y,xa-xb,color);
	}
}
