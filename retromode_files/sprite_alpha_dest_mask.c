...
void _left_right_alpha_dest_mask ROW_ARGS
{
	...
	{
		if (*source_row_ptr) *destination_row_ptr = (*destination_row_ptr &~destMask) | *source_row_ptr;
		destination_row_ptr++;
	}
}

void _right_left_alpha_dest_mask ROW_ARGS
{
	unsigned char *source_row_ptr;
	unsigned char *destination_row_ptr = destination_row_start;
